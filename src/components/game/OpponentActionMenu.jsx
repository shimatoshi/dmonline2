export const OpponentActionMenu = ({ target, onClose, onAction }) => {
  ...
  return (
    <div style={{
       ...
       boxShadow: "0 0 15px rgba(255, 0, 0, 0.5)", border: "1px solid #ff4444", textAlign: "center", minWidth: "220px"
     }}>
       ...
       <div style={{display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px"}}>
         ...
         <button className="btn" onClick={() => onAction("shield")} style={{background: "#ffc107", color:"black"}}>盾へ</button>
         <button className="btn" onClick={() => onAction("deckTop")} style={{background: "#333", color:"white"}}>山札上</button>
         <button className="btn" onClick={() => onAction("deckBottom")} style={{background: "#333", color:"white"}}>山札下</button>
         <button className="btn" onClick={() => onAction("grZone")} style={{background: "#2e7d32", color:"white"}}>GRへ</button>
         <button className="btn" onClick={() => onAction("hyperspace")} style={{background: "#00838f", color:"white"}}>超次元へ</button>
       </div>
